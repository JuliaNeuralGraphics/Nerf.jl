...
@kernel function _spherical_harmonics!(encodings, directions)
    i = @index(Global)
    x, y, z = directions[1, i], directions[2, i], directions[3, i]
...
@kernel function _∇spherical_harmonics!(∂L∂x, ∂L∂y, directions)
    i = @index(Global)
    x, y, z = directions[1, i], directions[2, i], directions[3, i]
